...
public class ServerClock {
	...
	public void start() {
		...
		while (true) {
			...
			if (currentTimeMillis >= (lastLoopCall + Constants.SESSION_TICK_RATE)) {
				...
				if (loopDuration >= Constants.SESSION_TICK_RATE) {
					System.out.println("tick exceeded server clock rate and took: " + loopDuration + "ms");				
				}
