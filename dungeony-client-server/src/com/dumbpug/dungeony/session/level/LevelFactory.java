...
public class LevelFactory {
	 ...
	 */
	private static Tiles createLevelTiles(Dungeon dungeon) {
		// Create the list to hold level tile entities.
		ArrayList<Tile> levelTiles = new ArrayList<Tile>();
		
		// TODO Populate the 'levelTiles' collection based on the tiles generated by the DunGen tool.
	 ...
	 */
	private static Enemies createLevelEnemies(Dungeon dungeon) {
		// Create the list to hold level enemies.
		ArrayList<Enemy> levelEnemies = new ArrayList<Enemy>();
		
		// TODO Populate the 'levelEnemies' collection based on the tiles generated by the DunGen tool.
